  ...
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      ...
      <div className='text-center'>
        <Link href={`/post/${post.slug}`}>
          <span className='transition duration-500 transform hover:-translate-y-1 cursor-pointer inline-block bg-blue-600 text-white px-8 py-3 font-medium text-lg rounded-full'>
            Continue Reading
          </span>
        </Link>
      </div>
